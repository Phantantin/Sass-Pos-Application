...
import com.tindev.repository.OrderItemRepository;
...
//                            .price(itemDto.getProduct().getSellingPrice() * itemDto.getQuantity())
    ...
    @Override
    public List<OrderDTO> getOrderByCashierId(Long cashierId) throws Exception {
