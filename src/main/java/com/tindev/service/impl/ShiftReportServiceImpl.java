...
public class ShiftReportServiceImpl implements ShiftReportService {
    ...
    public ShiftReportDTO endShift(Long shiftReportId, LocalDateTime shiftEnd) throws Exception {
        ...
        shiftReport.setPaymentSummaries(getPayemntSummaries(orders, totalSales));
    ...
    @Override
    public ShiftReportDTO getShiftCashierAndDate(Long cashierId, LocalDateTime date) throws Exception {
    ...
    private List<PaymentSummary> getPayemntSummaries(List<Order> orders, double totalSales) {
