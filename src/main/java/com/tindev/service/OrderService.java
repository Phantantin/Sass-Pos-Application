...
public interface OrderService {
    OrderDTO createOrder(OrderDTO order, String idempotencyKey) throws Exception;
    OrderDTO getOrderById(Long id) throws Exception;
    List<OrderDTO> getOrdersByBranch(Long branchId, Long customerId, Long cashierId,
